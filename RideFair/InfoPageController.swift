...
//        super.viewDidLoad()
//        print(VC.infoPageVC.selectedStop)
//        let stopCode = stopIDs[selectedStop] ?? "place-lake"
//        if (isWheelChairAccessible(stop: stopCode) == 1) {
//            imageView.image = UIImage(named: "wheelchair")
//        } else if (isWheelChairAccessible(stop: stopCode) == 2) {
//            imageView.image = UIImage(named: "notWheelchair")
//        }
//    }
//    
